...
export const ENRICHMENT_CATALOG: IntegrationCatalogItem[] = [
  {
    provider: "hunter",
    label: "Hunter.io",
    kind: "enrichment",
    ...
    recommended: true,
    needsApiKey: true,
    baseUrlHint: "https://api.hunter.io/v2",
    description: "Trouve les emails pro à partir d'un domaine. 25 recherches/mois gratuit.",
    value: "Meilleur outil email finding par domaine.",
    cliSupport: "no",
  },
  {
    ...
    recommended: true,
    needsApiKey: true,
    baseUrlHint: "https://api.dropcontact.com/v1",
    description: "Enrichit les contacts B2B français : email vérifié + SIRET + poste. 100% RGPD.",
    value: "Indispensable pour les leads FR/BE.",
    cliSupport: "no",
  },
  {
    provider: "datagma",
    ...
    recommended: false,
    needsApiKey: true,
    baseUrlHint: "https://gateway.datagma.net/api/ingress/v2",
    description: "Enrichit depuis LinkedIn URL : email, téléphone, poste, entreprise.",
    value: "Très efficace sur les exports LinkedIn.",
    cliSupport: "no",
  },
  {
    provider: "kaspr",
    ...
    recommended: false,
    needsApiKey: true,
    baseUrlHint: "https://api.kaspr.io/v1",
    description: "Extension LinkedIn qui révèle numéros de téléphone + emails. 5 crédits/mois gratuit.",
    value: "Top pour récupérer les mobiles directs.",
    cliSupport: "no",
  },
  {
    provider: "icypeas",
    ...
    recommended: false,
    needsApiKey: true,
    baseUrlHint: "https://app.icypeas.com/api",
    description: "Trouve emails + vérification. 150 crédits gratuits à l'inscription.",
    value: "Bon complément à Hunter pour la vérification.",
    cliSupport: "no",
  },
  {
    provider: "apify",
    ...
    recommended: true,
    needsApiKey: true,
    baseUrlHint: "https://api.apify.com/v2",
    description: "Scraping Instagram, TikTok, LinkedIn, Google Maps à grande échelle.",
    value: "Le plus puissant pour les scrapes volumiques.",
    cliSupport: "no",
  },
  {
    provider: "serpapi",
    ...
    recommended: false,
    needsApiKey: true,
    baseUrlHint: "https://serpapi.com/search",
    description: "Scrape Google, Maps, LinkedIn via API propre. 100 recherches/mois gratuites.",
    value: "Alternative fiable à Google Maps scraper.",
    cliSupport: "no",
  },
];
